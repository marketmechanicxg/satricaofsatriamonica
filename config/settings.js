...
const WEBSITE_PIN = "25055";              // ← GANTI PIN

/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   2. NAMA PENERIMA   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Nama yang muncul di halaman utama (hero).                      */
const RECIPIENT_NAME = "Satria";           // ← GANTI NAMA
...
const MUSIC_TRACKS = [
  {
    ...
    startTime: 175,                           // ← MULAI DARI DETIK KE BERAPA
  },
];
...
const LETTER_PARAGRAPHS = [
  "Happy birthday to my favorite person 🤍 The one who always knows how to make my days better and my heart feel safe. Having you in my life is one of the greatest blessings I could ever ask for, and today I just want to celebrate the amazing person that you are. ",
  "Thank you for staying through every version of me. Thank you for understanding me on days when I’m difficult to understand, for being patient with me, and for always giving me comfort when I need it the most. Your love has brought so much peace and happiness into my life, and I’ll never stop being grateful for that. I hope this birthday brings you countless reasons to smile.",
  "I hope every dream you’ve been working for slowly becomes reality, every prayer you’ve whispered gets answered, and every step you take leads you to something beautiful. You deserve so much happiness, love, and success in your life. Most of all, I hope you never forget how loved you are. Not just today, but every single day. ",
